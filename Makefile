...
TESTS   := tests/test_golay tests/test_aes tests/test_basop tests/test_basop_firmware tests/test_fft tests/test_fft_firmware tests/test_tables tests/test_fec \
           tests/test_firmware tests/test_firmware_encode tests/test_blend tests/test_postfilter tests/test_unvoiced tests/test_voiced tests/test_frame tests/test_mbelib tests/test_synth tests/test_e2e \
