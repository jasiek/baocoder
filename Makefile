...
SRC     := src/golay.c src/ambe_basop.c src/ambe_fft.c src/ambe_encode_params.c src/ambe_fec.c src/ambe_params.c src/ambe_synth.c src/ambe_blend.c src/ambe_postfilter.c \
...
TESTS   := tests/test_golay tests/test_aes tests/test_basop tests/test_fft tests/test_tables tests/test_fec \
           tests/test_firmware tests/test_firmware_encode tests/test_blend tests/test_postfilter tests/test_mbelib tests/test_synth tests/test_e2e \
