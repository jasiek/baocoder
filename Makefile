...
SRC     := src/golay.c src/ambe_basop.c src/ambe_fft.c src/ambe_encode_params.c src/ambe_fec.c src/ambe_params.c src/ambe_synth.c src/ambe_blend.c src/ambe_postfilter.c src/ambe_unvoiced.c \
