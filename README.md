...
| `test_voiced` | `Vocoder_SynthesizeVoiced 0x0001DE10`'s stages, innermost outwards, each swept against the firmware on its own before the next is written. `Vocoder_ComputeHarmonicGains` `0x0001D71C` so far | 1 589 checks; 1 584 cases, **all bit-exact**, up to 56 harmonics |
